...
namespace AsianRest.Areas.admin.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LocCity,LocAddres,LocPhone,LocWorkHours")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LocCity,LocAddres,LocPhone,LocWorkHours")] Location location)
        {
            if (ModelState.IsValid)
            {
